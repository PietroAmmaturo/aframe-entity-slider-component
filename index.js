...
AFRAME.registerComponent('entity-slider', {
  ...
  update: function (oldData) {
    ...
    if (oldData.forwardTrigger && data.forwardTrigger !== oldData.forwardTrigger) {
      data.forwardTrigger.removeEventListener("click", slider.triggerSlideForward.bind(slider));
    }
    if (oldData.backwardTrigger && data.backwardTrigger !== oldData.backwardTrigger) {
      data.backwardTrigger.removeEventListener("click", slider.triggerSlideBackward.bind(slider));
    }
    //adding event listeners to the triggers
    if (data.forwardTrigger) {
      data.forwardTrigger.addEventListener("click", slider.triggerSlideForward.bind(slider));
    }
    if (data.backwardTrigger)
      data.backwardTrigger.addEventListener("click", slider.triggerSlideBackward.bind(slider));
  },
